...
Kit.create(name: "Andromeda Strain",
  kick: "Star 808 Kepler KIC",
  snare: "Plasmasphere Polar",
  hh_closed: "XXXXXXXXXXXXXXhat_radar_echoes_titan_surface",
  hh_open: "XXXXXXXXXXXXXXhat_open_cassini_saturn_radio_emmisions_1",
  melody: "Plasma 9 Voyager 1",
  texture: "XXXXXXXXXXXXXX",
  one_shot_1: "Whistler Waves EMFISIS",
  one_shot_2: "XXXXXXXXXXXXXone_shot_sonification_of_hubble_deep_space",
  groove_file: "groove_stardust_passing_comet_temple_1.mp3"
)
...
Sample.create(name: "Deep Space Hubble",
  filename: "hat_sonification_of_hubble_deep_space.mp3",
...
Sample.create(name: "Jupiter Magnetosphere Juno",
...
Sample.create(name: "Magnetic Drum THEMIS",
...
# Only need a filename in kits table for the below grooves, they are not sample objects.
# But I am curious where the info came from?
...
#   info_url: ""
#   )
# Sample.create(name: "Shields Up Cassini",
...
#   info_url: ""
#   )
# Sample.create(name: "Radar Echoes Titan Huygens",
#   filename: "groove_radar_echoes_titan_surface.mp3",
#   source_name: "titan",
#   thumbnail_file: "titan.jpeg",
...
#   info_url: ""
#   )
# Sample.create(name: "Passing Tempel 1 Stardust",
